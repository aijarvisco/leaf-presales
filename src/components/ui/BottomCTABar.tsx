...
export default function BottomCTABar() {
  ...
  return (
    <div
      ref={barRef}
      className={`fixed left-1/2 -translate-x-1/2 z-30 max-w-[calc(100vw-2rem)] transition-[transform,opacity] duration-300 ease-out motion-reduce:transition-none ${hidden ? 'translate-y-[calc(100%+2rem)] opacity-0 pointer-events-none' : 'translate-y-0 opacity-100'}`}
